...
class IncidentsPageController extends GetxController with GetSingleTickerProviderStateMixin {
  ...
  RxList<Incident> getListByActiveTab() {
    switch(activeTab.value) {
      case 'aberto':
        return authenticatedController.listOpenIncidents;
      case 'atendimento':
        return authenticatedController.listPendingIncidents;
      case 'finalizado':
        return authenticatedController.listClosedIncidents;
      case 'geral':
        return authenticatedController.listAllIncidents;
    }
